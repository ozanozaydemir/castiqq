...
import { Send, Trash2, UserPlus, MapPin, Loader2, Printer } from 'lucide-react'
...
export function SubmissionBuilder({ shareId, matches, draftSubmissionId, draftItems, pastRounds, canPropose }: {
  shareId: string; matches: MatchResult[]; draftSubmissionId: string | null; draftItems: DraftItem[]
